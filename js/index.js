            ...
            afterLoad:function(link,index){
                switch(index){
                    ...
                    case 3:
                        ...
                        move(".sec3Wrap") .set("margin-right","45%").duration("http://qqq.com/javascripts/1.5s").end();
                        break;
                    case 4:
                    ...
                    case 6:
                        $('#sec6li').bind('mouseover',function(){
                            $('#sec6pic').attr('src','images/weixin.jpg');

                        })
                        $('#sec6li').bind('mouseout',function(){
                            $('#sec6pic').attr('src','images/qq-1.jpg')
